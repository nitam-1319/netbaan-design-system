...
//
// Strategy: flat named re-exports (Ant-style `import { Button } from '@netbaan-project/ui'`).
...
// Public API surface of the design system. Regenerate after adding/removing components.
`;
