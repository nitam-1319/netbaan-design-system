...
function ChoiceCard({
  ...
  return (
    <RadioPrimitive.Root
      ...
      className={cn(
        "group border-border-strong bg-background relative flex flex-1 cursor-pointer items-start gap-3 rounded-lg border p-4 text-start transition-colors outline-none",
    ...
    >
      ...
      {showIndicator ? (
        <span
          ...
          aria-hidden="true"
          className={cn(
            "border-border-strong group-data-[checked]:border-primary group-data-[checked]:bg-primary mt-0.5 ms-auto flex size-4 shrink-0 items-center justify-center rounded-full border transition-colors"
          )}
        >
