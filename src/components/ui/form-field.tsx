...
const fieldControlVariants = cva(
  cn(
    "border-input bg-background text-foreground placeholder:text-muted-foreground dark:bg-input/30 flex w-full rounded-lg border bg-clip-padding transition-all outline-none",
